...
public class PedidoEncomienda extends Pedido {
    ...
    /**
     * Asignacion automatica: sobre el limite de peso de la moto se necesita
    ...
    public String asignarRepartidor() {
        if (pesoKg > PESO_MAXIMO_MOTO) {
            return registrarAsignacion(
                    new Repartidor("Marcela Rojas", "furgon de carga"),
                    "el paquete supera los " + PESO_MAXIMO_MOTO + " kg de la moto");
        }
        return registrarAsignacion(
                new Repartidor("Ignacio Perez", "moto"),
                "peso dentro del limite de la moto");
    }
