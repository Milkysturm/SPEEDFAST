...
public class PedidoComida extends Pedido {
    ...
    /**
     * Asignacion automatica: la comida caliente exige mochila termica, asi
     * que el criterio de eleccion depende de ese requerimiento.
     *
    ...
    public String asignarRepartidor() {
        if (requiereMochilaTermica) {
            return registrarAsignacion(
                    new Repartidor("Camila Soto", "moto con mochila termica"),
                    "el pedido debe llegar caliente");
        }
        return registrarAsignacion(
                new Repartidor("Diego Fuentes", "moto"),
                "no requiere mochila termica");
    }
