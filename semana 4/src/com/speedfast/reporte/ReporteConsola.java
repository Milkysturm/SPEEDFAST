...
public class ReporteConsola {
    ...
    /**
     * Compara los tiempos de una lista de pedidos.
     *
     * Sobrecarga de {@link #imprimirTablaComparativa(Pedido[])}: el sistema
     * trabaja con ArrayList, pero el reporte sigue sirviendo para un arreglo
     * simple. Se convierte y se reutiliza la version ya probada.
     *
     * @param pedidos pedidos a comparar
     */
    public static void imprimirTablaComparativa(List<Pedido> pedidos) {
        imprimirTablaComparativa(pedidos == null ? null : pedidos.toArray(new Pedido[0]));
    }

    /**
     * Muestra el pedido mas rapido y el mas lento de una lista.
     *
     * Sobrecarga de {@link #imprimirExtremos(Pedido[])}.
     *
     * @param pedidos pedidos a evaluar
     */
    public static void imprimirExtremos(List<Pedido> pedidos) {
        imprimirExtremos(pedidos == null ? null : pedidos.toArray(new Pedido[0]));
    }
